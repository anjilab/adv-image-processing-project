...
def inference(img_path, model, use_relu, use_sigmoid, is_train, resol=299, layer_idx=None):
    ...
    try:
        ...
        img_path = IMG_DIRECTORY_CUB_200_2011 + 'datasets/' + img_path
    except:
        img_path_split = img_path.split('/')
        print('inside except inference=======================', img_path_split, IMG_DIRECTORY_CUB_200_2011)
...
def create_new_dataset(out_dir, field_change, compute_fn, datasets=['train', 'val', 'test'], data_dir=''):
    ...
    for dataset in datasets:
        ...
        for d in data:
            ...
            new_data.append(new_d)
        print(os.path.join(out_dir, dataset + '.pkl'))
